...
class RecyclerViewAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.temperature.text = weatherModel.current.temperature + "°C"
        Picasso.get().load("http:" + weatherModel.current.condition.icon).into(holder.icon)
        holder.windSpeed.text = weatherModel.current.windSpeed + "Km/h"
